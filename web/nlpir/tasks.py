...
import nlpir as N
import test1 as T
# print os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "web")
...
loc_wordCount = os.path.dirname(os.path.abspath(__file__)) + "/Export/wordCount.csv"
loc_splitwordCount = os.path.dirname(os.path.abspath(__file__)) + "/Export/splitwordCount.csv"
